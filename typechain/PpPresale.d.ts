...
interface PpPresaleInterface extends ethers.utils.Interface {
  functions: {
    "PPTokenAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "PPTokenAddress",
    values?: undefined
  ): string;
...
export class PpPresale extends BaseContract {
  ...
  interface: PpPresaleInterface;

  functions: {
    PPTokenAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    PPTokenAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    PPTokenAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
